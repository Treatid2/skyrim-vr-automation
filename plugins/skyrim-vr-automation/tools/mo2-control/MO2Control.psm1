...
function Get-MO2ControlHelp {
    ...
    $data = [pscustomobject][ordered]@{
        ...
        note = 'Version 1.0.0 preserves the lifecycle contract, adds session-scoped durable controllers, explicit profile identity, MO2 Overwrite-bound task output, and retained failed-to-run dialog classification.'
    }
