...
Assert-Test ($entryPointText -match 'acceptedDataRetained = \$acceptedDataRetained[\s\S]{0,500}data = \$data') 'post-dispatch failure envelopes retain accepted response data and expose its provenance'
